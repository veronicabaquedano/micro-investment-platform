from rest_framework.views import (
    APIView,
)  # class-based view provided by Django Rest Framework (DRF) for building APIs.
from rest_framework.response import (
    Response,
)  # Used to return structured responses (e.g., JSON).
from rest_framework import (
    status,
)  # Provides HTTP status codes for responses (e.g., 201 Created, 400 Bad Request).
